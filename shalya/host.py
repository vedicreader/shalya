...
# %% auto #0
__all__ = ['SANDBOX', 'SECRET', 'NO_ROOTS', 'DENY', 'SKIP_DIRS', 'SKIP_SUFFIXES', 'MAX_VARS', 'LD_CHARS', 'Capability',
           'HostError', 'host_err', 'Host', 'CodeHost', 'WebHost', 'NotebookHost', 'MemoryHost', 'WatchHost',
           'SessionHost', 'ShellHost', 'ApiHost', 'GitHost', 'denied', 'ld_json', 'LocalHost', 'implemented']
...
from .core import Hit, MAX_API, MAX_FILE, MAX_GREP_HITS

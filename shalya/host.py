...
# %% auto #0
__all__ = ['SKIP_DIRS', 'SKIP_SUFFIXES', 'MAX_VARS', 'LD_CHARS', 'CONTENT_SEL', 'BLOCK_SEL', 'THIN_PAGE', 'MAX_PAGE',
           'MIN_SECTION', 'READERS', 'Capability', 'Host', 'CodeHost', 'WebHost', 'NotebookHost', 'MemoryHost',
           'AskHost', 'WatchHost', 'SessionHost', 'ShellHost', 'ApiHost', 'GitHost', 'ld_json', 'LocalHost', 'md_title',
